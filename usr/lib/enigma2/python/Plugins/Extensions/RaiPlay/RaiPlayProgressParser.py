        ...
        try:
            if not self.header_processed:
                if 'Duration:' in data_line:
                    ...
                    if detected_duration > 0 and (detected_duration < self.total_duration_seconds or 0 == self.total_duration_seconds):
                        ...
                        print("[RAIPLAY PARSER] Total duration found: {}s".format(self.total_duration_seconds))
            ...
            if 'frame=' in data_line:
                ...
                if self.total_duration_seconds > 0 and current_duration > 0:
                    ...
                    print("[RAIPLAY PARSER] Progress: {}s/{}s = {}%".format(current_duration, self.total_duration_seconds, completion_pct))
                    ...
                    if estimated_total_size > 0:
                        ...
                        progress_data['completion_percentage'] = completion_pct
                        print("[RAIPLAY PARSER] Size-based progress: {}/{} = {}%".format(file_size_bytes, estimated_total_size, completion_pct))

        except Exception as parse_error:
            print("[RAIPLAY PARSER] Error analyzing output: {}".format(parse_error))
